...
def show_page(page_name):
    ...
    pages = ['index', 'unloadedgame', 'memory_game', 'mazegame', 'tictactoe', 'balloon_popper', 'minesweeper', 'whack_a_mole', 'pacman', 'tetris', 'snake_game', 'bubble_shooter', 'sudoku', 'trail', 'tower_blocks', 'flappy_bird']
